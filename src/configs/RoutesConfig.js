...
export const publicRoutes = [
  ...
  {
    key: "login-2",
    path: `${AUTH_PREFIX_PATH}/dealer/login`,
    component: React.lazy(() =>
      import("views/auth-views/authentication/login-2")
    ),
  },
...
export const protectedRoutes = [
  ...
  // dealers
  {
    key: "apps.watches.dealer-dashboard",
    path: `${APP_PREFIX_PATH}/apps/watches/dealer-dashboard`,
    component: React.lazy(() =>
      import("views/app-views/apps/e-commerce/dealer-dashboard")
    ),
  },
  {
    ...
    component: React.lazy(() =>
      import("views/app-views/apps/e-commerce/add-dealer")
    ),
  },
  {
    ...
    component: React.lazy(() =>
      import("views/app-views/apps/e-commerce/edit-dealer")
    ),
  },
  {
    ...
    component: React.lazy(() =>
      import("views/app-views/apps/e-commerce/dealer-list")
    ),
  },
  // customers
  {
    ...
    component: React.lazy(() =>
      import("views/app-views/apps/e-commerce/add-customer")
    ),
  },
  {
  ...
  },
  {
    ...
    component: React.lazy(() =>
      import("views/app-views/apps/e-commerce/customer-list")
    ),
  },
  // commission
  {
    ...
    component: React.lazy(() =>
      import("views/app-views/apps/e-commerce/edit-commission")
    ),
  },
  // products
  {
  ...
  },
  {
    ...
    component: React.lazy(() =>
      import("views/app-views/apps/e-commerce/transactions")
    ),
  },
  {
