...
let navigationConfigV;
if (role == "customer") {
  navigationConfigV = navigationConfig.navigationConfigCustomer;
} else if (role == "dealer") {
  navigationConfigV = navigationConfig.navigationConfigDealer;
} else {
  navigationConfigV = navigationConfig.navigationConfigAdmin;
}
...
const SideNavContent = (props) => {
  ...
  const menuItems = useMemo(() => getSideNavMenuItem(navigationConfigV), []);
...
const TopNavContent = () => {
  ...
  const menuItems = useMemo(() => getTopNavMenuItem(navigationConfigV), []);
