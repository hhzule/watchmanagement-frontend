  ...
  return (
    <div>
      ...
      <p>
        ...
        as base routing system. To add a new route in the template, you can
      ...
      <div className="mt-4">
        ...
        <p class="my-1">
          ...
          <code>src/configs/RoutesConfig.js</code>, there's 2 type of route
          group as following.
        </p>
        <ul>
          <li>
      ...
      <div className="mt-4">
        ...
        <p class="mt-1">
          ...
          on the authority you wish to. Refer below mentioned code to create a
          route:
        </p>
      ...
      <div className="mt-4">
        ...
        <p className="mt-1">
          ...
          <code>AppRoute</code> or the view component under this route.
        </p>
        <SyntaxHighlighter
          className="hl-code"
          language="jsx"
        ...
        >{`export const protectedRoutes = [
	{
      ...
      <div className="mt-4">
        ...
        <p>
          You can config your navigation bar in{" "}
          <code>configs/NavigationConfig.js</code>. We grouped up the navigation
          tree as an array, add object as the code below to the array for new
          menu item.
        </p>
        <SyntaxHighlighter
          className="hl-code"
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>submenu</td>
              <td>
                Whether have child in this menu item, only accept properties in
                this table
              </td>
              <td>array</td>
            </tr>
